defmodule HumanResourcesWeb.CoreComponents do
  @moduledoc """
  ...
  import HumanResourcesWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HumanResourcesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HumanResourcesWeb.Gettext, "errors", msg, opts)
    end
  end
